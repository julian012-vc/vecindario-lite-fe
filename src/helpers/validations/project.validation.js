...
export const CREATE_FORM_VALIDATION = {
  ...
  private_area: yup.number().required(Errors.REQUIRED_ERROR),
  building_area: yup.number().required(Errors.REQUIRED_ERROR),
  price: yup.number().required(Errors.REQUIRED_ERROR),
  ...
  bathrooms: yup.number().required(Errors.REQUIRED_ERROR),
};
